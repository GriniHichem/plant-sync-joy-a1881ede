...
const MODULES: AppModule[] = [
  ...
  { title: "Pièces de rechange", description: "Catalogue PDR, stock et liens machines", url: "/pdr", icon: IconSpare, category: "Maintenance", permissionModule: "pdr", accent: "from-sky-600/15 to-sky-600/5 text-sky-600" },
  { title: "Demandes pièces", description: "File des demandes de pièces à préparer", url: "/pdr/demandes", icon: IconSpare, category: "Maintenance", permissionModule: "pdr_demandes", accent: "from-purple-500/15 to-purple-500/5 text-purple-500" },
  { title: "Shift Magasin", description: "Espace magasinier & supervision magasin", url: "/magasin/shift", icon: IconShift, category: "Maintenance", permissionModule: "shift_magasin", badge: "Live", accent: "from-purple-600/15 to-purple-600/5 text-purple-600" },
