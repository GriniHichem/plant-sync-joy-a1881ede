...
const MODULES: AppModule[] = [
  ...
  { title: "Pièces de rechange", description: "Catalogue PDR, stock et liens machines", url: "/pdr", icon: IconSpare, category: "Stock PDR", permissionModule: "pdr", accent: "from-sky-600/15 to-sky-600/5 text-sky-600" },
  { title: "Demandes pièces", description: "File des demandes de pièces à préparer", url: "/pdr/demandes", icon: IconSpare, category: "Stock PDR", permissionModule: "pdr_demandes", accent: "from-purple-500/15 to-purple-500/5 text-purple-500" },
  { title: "Dashboard PDR", description: "Supervision temps réel du stock et du magasin", url: "/magasin/shift", icon: IconChart, category: "Stock PDR", permissionModule: "shift_magasin", accent: "from-violet-500/15 to-violet-500/5 text-violet-500" },
  { title: "Shift Magasin", description: "Espace magasinier (kiosque temps réel)", url: "/magasin/shift/live", icon: IconShift, category: "Stock PDR", permissionModule: "shift_magasin", badge: "Live", accent: "from-purple-600/15 to-purple-600/5 text-purple-600" },
  { title: "Journal Stock", description: "Historique des mouvements de stock", url: "/magasin/journal", icon: IconJournal, category: "Stock PDR", permissionModule: "journal_stock", accent: "from-violet-600/15 to-violet-600/5 text-violet-600" },
